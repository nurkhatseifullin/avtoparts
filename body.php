				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=8"><div class="shop">
							...
							<div class="shop-body">
								<h3>BMW<br>Collection</h3>
								<a href="product.php?p=8" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
							</div>
                            </div></a>
					</div>
					<!-- /shop -->
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab1">Generator belt</a></li>
									<li><a data-toggle="tab" href="#tab1">Spark plug</a></li>
									<li><a data-toggle="tab" href="#tab1">Wiper</a></li>
									<li><a data-toggle="tab" href="#tab1">Timing belt</a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					$product_query = "SELECT * FROM products,categories WHERE product_cat=cat_id AND product_id BETWEEN 1 AND 100";
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					$product_query = "SELECT * FROM products,categories WHERE product_cat=cat_id AND product_id BETWEEN 92 AND 108";
                $run_query = mysqli_query($con,$product_query);
                if(mysqli_num_rows($run_query) > 0){
